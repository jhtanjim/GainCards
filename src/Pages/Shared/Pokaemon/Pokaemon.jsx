  ...
  if (!pokemons || pokemons.length === 0) {
    return (
      <div className="text-center py-16 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg max-w-lg mx-auto mt-10">
        ...
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">No Pokemon cards found</h2>
        <p className="text-gray-600 mb-6">There are currently no Pokemon cards available in the collection.</p>
      </div>
    )
  }
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-6 mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            ...
            <p className="text-blue-100">Discover amazing Pokemon cards and donations</p>
          </div>
      ...
      {processedPokemons.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          ...
          <h3 className="text-lg font-semibold text-gray-700 mb-2">No cards found</h3>
